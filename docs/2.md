...
- 5.模块化思想在项目中如何实践的？
- 6.export 是什么？
- 7.module.export、export 与 export defalut 有什么区别？
- 8.什么是组件化？
- 9.组件化的原则是什么？
- 10.全局组件与局部组件的区别？
- 11.如何注册一个全局组件，并使用它？
- 12.局部组件又是如何注册并使用的？
- 13.如何封装一个高复用的 Vue 前端组件？
- 14.什么是前端工程化思想？
- 15.工程化可以解决什么问题？
- 16.是如何处理这些问题的？
...
##### **问：7.export defalut、export 与 module.exports 有什么区别？**
...
export 是单个暴露数据或方法，利用 import{}来引入，并且{}内名称与 export 一一对应，{}也使用 as 为某个数据或方法指定新的名称；
